***This document is best viewed in [flatdoc format](http://oraopensource.github.io/flatdoc?user=oraopensource&repo=logger&path=docs%2FLogger+API.md)***
...
- [Other Logger Procedures](#other-logger-procedures)
...
- [Utility Functions](#utility-functions)
  ...
  - [CONVERT_LEVEL_CHAR_TO_NUM](#procedure-convert_level_char_to_num)
  - [DATE_TEXT_FORMAT](#procedure-date_text_format)
  - [GET_CHARACTER_CODES](#procedure-get_character_codes)
- [Set Logging Level](#set-logging-level)
  - [SET_LEVEL](#procedure-set_level)
  - [UNSET_CLIENT_LEVEL](#procedure-unset_client_level)
  - [UNSET_CLIENT_LEVEL](#procedure-unset_client_level2)
  - [UNSET_CLIENT_LEVEL_ALL](#procedure-unset_client_level_all)
- [Timing Procedures](#timing-procedures)
  - [TIME_RESET](#procedure-time_reset)
  - [TIME_START](#procedure-time_start)
  - [TIME_STOP](#procedure-time_stop)
  - [TIME_STOP](#procedure-time_stop2)
  - [TIME_STOP_SECONDS](#procedure-time_stop_seconds)
- [Other Procedures](#timing-procedures)
  - [APPEND_PARAM](#procedure-append_param)
  - [OK_TO_LOG](#procedure-ok_to_log)  
